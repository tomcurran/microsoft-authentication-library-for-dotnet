...
namespace Microsoft.Identity.Client
{
    ...
    internal static class MsalErrorMessage
    {
        ...
        public const string NoAccountForLoginHintAccountManager = "You are trying to acquire a token silently using a login hint and broker. No account was found in the android account manager having this login hint.";
